...
namespace DHR.Migrations
{
    ...
    [Migration("20250120073720_EmployeeWorkEntryRequest")]
    partial class EmployeeWorkEntryRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DHR.Models.EmployeePermissionRequest", b =>
                {
                    ...
                    b.Property<string>("PersonnelRemarks")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DHR.Models.EmployeeWorkEntryRequest", b =>
                {
                    b.Property<int>("EmployeeWorkEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmployeeWorkEntryId"));
                    ...
                    b.Property<string>("EmployeeWorkEntryCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<string>("PersonnelRemark")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("WorkReason")
                        .HasColumnType("nvarchar(max)");

                    b.Property<TimeOnly?>("WorkStartTime")
                        .HasColumnType("time");

                    b.HasKey("EmployeeWorkEntryId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("EmployeeWorkEntryRequests");
                });
            ...
            modelBuilder.Entity("DHR.Models.EmployeeWorkEntryRequest", b =>
                {
                    b.HasOne("DHR.Models.EmployeeModel", "Employee")
                        .WithMany("EmployeeWorkEntryRequests")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DHR.Models.EmployeeModel", b =>
                {
                    ...
                    b.Navigation("EmployeeWorkEntryRequests");
