...
namespace DAHAR.Migrations
{
    ...
    [Migration("20241202032923_FormApplicationRequest")]
    partial class FormApplicationRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAHAR.Models.AttendanceStatusModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.CompanyModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.DepartmentModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.DivisionModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.EducationModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.EmployeeDependentModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.EmployeeModel", b =>
                {
                    b.Property<int>("EmployeeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.FormApplicationRequestModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.JobTitleModel", b =>
                {
                    b.Property<int>("JobTitleID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.LocationModel", b =>
                {
                    b.Property<int>("LocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.PeriodModel", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.ReligionModel", b =>
                {
                    b.Property<int>("ReligionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.SubDepartmentModel", b =>
                {
                    b.Property<int>("SubDepartmentID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.SubUnitModel", b =>
                {
                    b.Property<int>("SubUnitID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.TaxExemptIncomeModel", b =>
                {
                    b.Property<int>("TaxExemptIncomeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.UnitModel", b =>
                {
                    b.Property<int>("UnitID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAHAR.Models.Users", b =>
                {
            ...
            modelBuilder.Entity("DAHAR.Models.CompanyModel", b =>
                {
                    b.HasOne("DAHAR.Models.LocationModel", "Location")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("DAHAR.Models.DepartmentModel", b =>
                {
                    b.HasOne("DAHAR.Models.CompanyModel", "Company")
            ...
            modelBuilder.Entity("DAHAR.Models.DivisionModel", b =>
                {
                    b.HasOne("DAHAR.Models.SubDepartmentModel", "SubDepartment")
                        .WithMany("Divisions")
            ...
            modelBuilder.Entity("DAHAR.Models.EmployeeDependentModel", b =>
                {
                    b.HasOne("DAHAR.Models.EmployeeModel", "Employee")
            ...
            modelBuilder.Entity("DAHAR.Models.EmployeeModel", b =>
                {
                    b.HasOne("DAHAR.Models.DivisionModel", "Division")
                        .WithMany("Employees")
                        .HasForeignKey("DivisionID");

                    b.HasOne("DAHAR.Models.EducationModel", "Education")
                        .WithMany("Employees")
                        .HasForeignKey("EducationId");

                    b.HasOne("DAHAR.Models.JobTitleModel", "JobTitle")
                        .WithMany("Employees")
                        .HasForeignKey("JobTitleID");

                    b.HasOne("DAHAR.Models.ReligionModel", "Religion")
                        .WithMany("Employees")
                        .HasForeignKey("ReligionId");

                    b.HasOne("DAHAR.Models.SubUnitModel", "SubUnit")
                        .WithMany("Employees")
                        .HasForeignKey("SubUnitId");

                    b.HasOne("DAHAR.Models.TaxExemptIncomeModel", "TaxExemptIncome")
                        .WithMany("Employees")
                        .HasForeignKey("TaxExemptIncomeId");

                    b.HasOne("DAHAR.Models.Users", "Users")
                        .WithOne()
                        .HasForeignKey("DAHAR.Models.EmployeeModel", "UserId");
            ...
            modelBuilder.Entity("DAHAR.Models.SubDepartmentModel", b =>
                {
                    b.HasOne("DAHAR.Models.DepartmentModel", "Department")
            ...
            modelBuilder.Entity("DAHAR.Models.SubUnitModel", b =>
                {
                    ...
                    b.HasOne("DAHAR.Models.UnitModel", "Unit")
                        .WithMany("SubUnits")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DAHAR.Models.Users", null)
                        .WithMany()
